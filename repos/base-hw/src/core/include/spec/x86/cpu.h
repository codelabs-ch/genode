...
class Genode::Cpu
{
	public:
		...
		struct User_context : Context
		{
			...
			void user_arg_3(Kernel::Call_arg const arg) { r10 = arg; }
			void user_arg_4(Kernel::Call_arg const arg) { r8 = arg; }
			void user_arg_5(Kernel::Call_arg const arg) { r9 = arg; }
			void user_arg_6(Kernel::Call_arg const arg) { r12 = arg; }
			void user_arg_7(Kernel::Call_arg const arg) { r13 = arg; }
			...
			Kernel::Call_arg user_arg_3() const { return r10; }
			Kernel::Call_arg user_arg_4() const { return r8; }
			Kernel::Call_arg user_arg_5() const { return r9; }
			Kernel::Call_arg user_arg_6() const { return r12; }
			Kernel::Call_arg user_arg_7() const { return r13; }
